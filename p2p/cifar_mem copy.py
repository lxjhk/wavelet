        ...
        for batch_idx, (inputs, targets) in enumerate(trainloader):
            ...
            if batch_idx >= 2:
                ...
                for idx, param in enumerate(list(model.parameters())):
                    ...
                    print("\n GPU 0 received, uuid", uuid, "grad", grad.dtype)
            ...
            if batch_idx >= 1:
                ...
                # print("GPU0 Putting")
                for idx, param in enumerate(list(model.parameters())):
                    print("\n--- GPU 0 put in uuid", idx, "grad", param.grad.dtype)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for batch_idx, (inputs, targets) in enumerate(trainloader):
            ...
            if batch_idx >= 1:
                ...
                for idx, param in enumerate(list(model.parameters())):
                    uuid, grad = receiveQueue.get()
                    print("\n--- GPU 1 received uuid", uuid, "grad", grad.dtype)
            ...
            if batch_idx >= 1:
                ...
                # remote_pdb.set_trace()
                for idx, param in enumerate(list(model.parameters())):
                    print("\n GPU 1 put in uuid", idx, "grad", param.grad.dtype)
                    sendQueue.put((idx, param.grad))
